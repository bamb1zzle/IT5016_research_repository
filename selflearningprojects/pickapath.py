...
print("2. Sprint down the hall further away from the door.")

do= int(input(""))

if do == 1:
    print("The murderers are not so merciful and decide to kill you. \n ***GAME OVER***")
    exit()

elif do == 2:
    print("You bolt down the hall and the thieves are seconds away from bursting your front door open. You meet two doors at the end of the hall. Which door do you enter?")
    print("1. Your bedroom door.")
    print("2. Your bathroom door.")

    do =int(input(""))
    if do == 1:
        print("You enter your room but the thieves had just caught a glimpse of you whilst bursting open the door and proceed to run down the hall.")
        ...
        do = int(input(""))
        if do == 1: 
            print("You squeeze into your tiny closet amongst your dainty dresses and fat coats. The thieves enter into your bedroom and ravage around trying to find you. As they approach the closet your nervousness peaks and you break out in a scream. You are now dead. \n ***GAME OVER***")
        else:
        ...
        if do == 1:
            ...
            print("While sitting against the corner of the bathroom and reflecting on your life you notice that some bricks are loose in the wall. You begin to probe the wall and notice two bricks that can be fully indented and pushed into the wall. Which brick do you press into? The LEFT BRICK or RIGHT BRICK?")  
...
#Thank you for playing my game. Inspired by the show "Only Murders In The Building".